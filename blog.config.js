...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '种田的黄油', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'The unexamined life is not worth living.', // 副标题
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tanedanobata.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Blog, 博客, 种田的黄油, UE5, UE4, Unreal Engine, C++, 图形学, 计算机图形学, Computer Graphics', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'aizawaaayame@outlook.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/aizawaayame', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/chihaya.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
